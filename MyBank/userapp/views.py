    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                is_customer = user_obj.groups.filter(name='customer').exists()
                
                if is_customer:
                    password_valid = check_password(data['password'], user_obj.password)
                else:
                    password_valid = (data['password'] == user_obj.password)
